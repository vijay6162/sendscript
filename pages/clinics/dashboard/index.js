...
const ClinicProfileCard  = ()  => {
  return(
    <Box borderWidth={1} borderColor={'#D5D5D5'} padding={2} borderRadius={12} marginTop={2}>
      <Box display="flex" flexDirection={'row'} >
          <Image src={'/avatar.png'} width={'80px'} objectFit="contain" />
          <Box margin={4}>
            <Text fontFamily={'Poppins'} fontWeight={'semibold'} fontSize={14} color={'#104076'}>Dr. Govind Bankani</Text>
            <Text fontFamily={'Poppins'} fontWeight={'regular'} fontSize={9} color={'#104076'}>General Physician</Text>
            <Text fontFamily={'Poppins'} fontWeight={'regular'} fontSize={13} color={'#104076'}>LEH123456</Text>
            <Text fontFamily={'Poppins'} fontWeight={'regular'} fontSize={12} color={'#104076'}>Mon, Wed & Fri (10am - 3pm)</Text>
          </Box>
      </Box>
    </Box>
